  ...
  return (
    <section className="w-full bg-[#f4f4f4] px-4 py-8 sm:px-8 md:px-12 lg:px-16">
      <div className="mx-auto flex max-w-7xl flex-col justify-between gap-10 lg:flex-row lg:items-center">
        ...
        {/* Right Side */}
        <div className="grid grid-cols-3 gap-8 sm:gap-12 md:gap-16 lg:gap-20">
          ...
          <div>
            ...
            <p className="mt-2 whitespace-nowrap text-[9px] font-medium uppercase tracking-[0.18em] text-gray-500">
              Commission Only
            </p>
          </div>
