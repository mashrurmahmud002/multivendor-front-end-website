    ...
    <section className="w-full bg-white px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 gap-0 lg:min-h-[calc(100vh-106px)] lg:grid-cols-[2fr_0.9fr]">
        ...
        <div className="flex flex-col justify-between py-10 pr-0 lg:pr-8">
          ...
          {/* Small Label */}
          <div>
            <p className="mb-7 text-[10px] font-semibold uppercase tracking-[1.5px] text-gray-600">
              The Multivendor Marketplace
            </p>

            {/* Main Heading */}
            <h1 className="max-w-[520px] text-[46px] font-black uppercase leading-[0.88] tracking-[-2px] text-black sm:text-[64px] sm:tracking-[-3px] md:text-[78px] lg:text-[88px] lg:tracking-[-4px] xl:text-[92px]">
              Every
              <br />
              Seller.
              <br />
          ...
          <div className="mt-12 border-t border-gray-200 pt-7">
            <div className="flex flex-wrap gap-8 sm:gap-12">
              ...
              <div>
                ...
                <p className="mt-1 text-[9px] font-medium uppercase tracking-[0.7px] text-gray-500">
                  Active Vendors
                </p>
              </div>
        ...
        {/* ================= RIGHT IMAGE ================= */}
        <div className="relative mt-6 h-[320px] overflow-hidden border-l border-black sm:h-[420px] lg:mt-0 lg:h-full">
          ...
          <div className="absolute bottom-5 left-5 bg-black px-2 py-1">
            <p className="text-[9px] font-bold uppercase tracking-[0.7px] text-white">
              84K+ Active Vendors
            </p>
          </div>
